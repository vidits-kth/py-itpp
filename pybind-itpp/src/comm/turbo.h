...
void generate_pybind_wrapper_for_itpp_turbo_codec_class( py::module &m ) {
  ...
  py::class_<itpp::Turbo_Codec>( m, "turbo_codec" )
    ...
    .def("set_parameters", &itpp::Turbo_Codec::set_parameters
                         ...
                         ,  py::arg( "in_iterations"), py::arg("in_metric"), py::arg("in_logmax_scale_factor"), py::arg("in_adaptive_stop"), py::arg("lcalc"))
    ...
    .def("decode", static_cast<void (itpp::Turbo_Codec::*)(const itpp::vec &,
                                                          ...
                                                          const itpp::bvec &)>(&itpp::Turbo_Codec::decode)
                 , "Decoder function"
                 , py::arg( "received_signal"), py::arg("decoded_bits"), py::arg("nrof_used_iterations"), py::arg("true_bits"))
    ...
    .def("decode_block", &itpp::Turbo_Codec::decode_block
                       ...
                       , py::arg( "rec_syst1"), py::arg("rec_syst2"), py::arg("rec_parity"), py::arg("rec_parity2"), py::arg("decoded_bits_i"), py::arg("nrof_used_iterations_i"), py::arg("true_bits"))
