...
//  ivec find(const bvec &invector);
  ...
  */
  ...
  boost::python::def("ones", static_cast<itpp::vec (*)(int)>(&itpp::ones), boost::python::return_value_policy<boost::python::return_by_value>());
//  vec ones(int size);
  //! A Binary vector of ones
  boost::python::def("ones_b", static_cast<itpp::bvec (*)(int)>(&itpp::ones_b), boost::python::return_value_policy<boost::python::return_by_value>());
//  bvec ones_b(int size);
  //! A Int vector of ones
  boost::python::def("ones_i", static_cast<itpp::ivec (*)(int)>(&itpp::ones_i), boost::python::return_value_policy<boost::python::return_by_value>());
//  ivec ones_i(int size);
  //! A float Complex vector of ones
  boost::python::def("ones_c", static_cast<itpp::cvec (*)(int)>(&itpp::ones_c), boost::python::return_value_policy<boost::python::return_by_value>());
//  cvec ones_c(int size);

  //! A float (rows,cols)-matrix of ones
  boost::python::def("ones", static_cast<itpp::mat (*)(int, int)>(&itpp::ones), boost::python::return_value_policy<boost::python::return_by_value>());
//  mat ones(int rows, int cols);
  //! A Binary (rows,cols)-matrix of ones
  boost::python::def("ones_b", static_cast<itpp::bmat (*)(int, int)>(&itpp::ones_b), boost::python::return_value_policy<boost::python::return_by_value>());
//  bmat ones_b(int rows, int cols);
  //! A Int (rows,cols)-matrix of ones
  boost::python::def("ones_i", static_cast<itpp::imat (*)(int, int)>(&itpp::ones_i), boost::python::return_value_policy<boost::python::return_by_value>());
//  imat ones_i(int rows, int cols);
  //! A Double Complex (rows,cols)-matrix of ones
  boost::python::def("ones_c", static_cast<itpp::cmat (*)(int, int)>(&itpp::ones_c), boost::python::return_value_policy<boost::python::return_by_value>());
//  cmat ones_c(int rows, int cols);

  //! A Double vector of zeros
  boost::python::def("zeros", static_cast<itpp::vec (*)(int)>(&itpp::zeros), boost::python::return_value_policy<boost::python::return_by_value>());
//  vec zeros(int size);
  //! A Binary vector of zeros
  boost::python::def("zeros_b", static_cast<itpp::bvec (*)(int)>(&itpp::zeros_b), boost::python::return_value_policy<boost::python::return_by_value>());
//  bvec zeros_b(int size);
  //! A Int vector of zeros
  boost::python::def("zeros_i", static_cast<itpp::ivec (*)(int)>(&itpp::zeros_i), boost::python::return_value_policy<boost::python::return_by_value>());
//  ivec zeros_i(int size);
  //! A Double Complex vector of zeros
  boost::python::def("zeros_c", static_cast<itpp::cvec (*)(int)>(&itpp::zeros_c), boost::python::return_value_policy<boost::python::return_by_value>());
//  cvec zeros_c(int size);

  //! A Double (rows,cols)-matrix of zeros
  boost::python::def("zeros", static_cast<itpp::mat (*)(int, int)>(&itpp::zeros), boost::python::return_value_policy<boost::python::return_by_value>());
//  mat zeros(int rows, int cols);
  //! A Binary (rows,cols)-matrix of zeros
  boost::python::def("zeros_b", static_cast<itpp::bmat (*)(int, int)>(&itpp::zeros_b), boost::python::return_value_policy<boost::python::return_by_value>());
//  bmat zeros_b(int rows, int cols);
  //! A Int (rows,cols)-matrix of zeros
  boost::python::def("zeros_i", static_cast<itpp::imat (*)(int, int)>(&itpp::zeros_i), boost::python::return_value_policy<boost::python::return_by_value>());
//  imat zeros_i(int rows, int cols);
  //! A Double Complex (rows,cols)-matrix of zeros
  boost::python::def("zeros_c", static_cast<itpp::cmat (*)(int, int)>(&itpp::zeros_c), boost::python::return_value_policy<boost::python::return_by_value>());
//  cmat zeros_c(int rows, int cols);

  //! A Double (size,size) unit matrix
  boost::python::def("eye", static_cast<itpp::mat (*)(int)>(&itpp::eye), boost::python::return_value_policy<boost::python::return_by_value>());
//  mat eye(int size);
  //! A Binary (size,size) unit matrix
  boost::python::def("eye_b", static_cast<itpp::bmat (*)(int)>(&itpp::eye_b), boost::python::return_value_policy<boost::python::return_by_value>());
//  bmat eye_b(int size);
  //! A Int (size,size) unit matrix
  boost::python::def("eye_i", static_cast<itpp::imat (*)(int)>(&itpp::eye_i), boost::python::return_value_policy<boost::python::return_by_value>());
//  imat eye_i(int size);
  //! A Double Complex (size,size) unit matrix
  boost::python::def("eye_c", static_cast<itpp::cmat (*)(int)>(&itpp::eye_c), boost::python::return_value_policy<boost::python::return_by_value>());
//  cmat eye_c(int size);
